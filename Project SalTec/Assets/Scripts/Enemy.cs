...
public class Enemy : Mover
{
    ...
    protected override void Death()
    {
        ...
        GameManager.instance.ShowText("+ " + xpValue + " xp", 55, Color.magenta, transform.position, Vector3.up * 40, 1.0f);
    }
}
